...
// import 'package:protectmee/styles/app_styles.dart';

// class HelpCenters extends StatefulWidget {
//   final ValueChanged<String> onLocationSelected;
//    const HelpCenters({Key? key, required this.onLocationSelected}) : super(key: key);
...
import '../../../presentation/widgets/helpcenter_map.dart';


class HelpCenters extends StatelessWidget {
  final ValueChanged<String> onLocationSelected;

  const HelpCenters({super.key, required this.onLocationSelected});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      
      body: HelpCenterWidget(onLocationSelected: onLocationSelected),
    );
  }
}

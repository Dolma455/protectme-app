...
class HelpCenterReports extends StatelessWidget {
  final List<HelpCenterReport> reports = [
    HelpCenterReport(
      incidentType: 'Theft',
  ...
  void _showReportDetails(BuildContext context, HelpCenterReport report) {
    showDialog(
      context: context,
